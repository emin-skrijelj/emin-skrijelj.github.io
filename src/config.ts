...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/emin-skrijelj',     // Internal links should not include the base path, as it is automatically added
  ...
  links: [
    {
      ...
      url: 'https://twitter.com/L3G4CY5',
    },
    {
      name: 'GitHub',
      icon: 'fa6-brands:github',
      url: 'https://github.com/emin-skrijelj',
    },
  ],
}
